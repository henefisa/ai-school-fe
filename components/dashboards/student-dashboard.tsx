...
import { BookOpenIcon, CalendarIcon, FileTextIcon, GraduationCapIcon, BellIcon, ClockIcon } from "lucide-react"

export default function StudentDashboard() {
  // Sample courses data
  const courses = [
    { id: 1, name: "Algebra I", teacher: "Dr. Robert Chen", grade: "A", progress: 85 },
    { id: 2, name: "English Literature", teacher: "Sarah Johnson", grade: "A-", progress: 90 },
    { id: 3, name: "Biology", teacher: "Michael Williams", grade: "B+", progress: 78 },
    { id: 4, name: "World History", teacher: "Emily Davis", grade: "A", progress: 92 },
  ]

  // Sample assignments data
  const assignments = [
    { id: 1, title: "Quadratic Equations", course: "Algebra I", dueDate: "Mar 20, 2025", status: "Pending" },
    {
      id: 2,
    ...
    { id: 4, title: "World War II Research", course: "World History", dueDate: "Mar 25, 2025", status: "Pending" },
  ]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome back! Here&apos;s an overview of your courses and assignments.</p>
      </div>
