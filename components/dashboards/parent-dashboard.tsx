...
import { CalendarIcon, CreditCardIcon, BellIcon, MessageSquareIcon } from "lucide-react"
...
export default function ParentDashboard() {
  ...
  const events = [
    { id: 1, title: "Parent-Teacher Meeting", date: "Mar 20, 2025", type: "meeting" },
    { id: 2, title: "Science Fair", date: "Apr 5, 2025", type: "event" },
    { id: 3, title: "End of Quarter Exams", date: "Mar 25, 2025", type: "exam" },
  ]

  // Sample fee information
  const fees = [
    { id: 1, description: "Tuition Fee (Q1)", amount: 1500, status: "Paid", dueDate: "Jan 15, 2025" },
    { id: 2, description: "Tuition Fee (Q2)", amount: 1500, status: "Paid", dueDate: "Mar 15, 2025" },
    { id: 3, description: "Field Trip Fee", amount: 75, status: "Pending", dueDate: "Apr 1, 2025" },
  ]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome back! Here&apos;s an overview of your children&apos;s progress.</p>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{child.attendance}%</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{child.gpa}/4.0</span>
                  </div>
        ...
        <TabsContent value="academics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your children's grades and performance</CardDescription>
            </CardHeader>
            <CardContent className="h-[300px] flex items-center justify-center border-2 border-dashed rounded-lg">
              <p className="text-muted-foreground">Detailed academic reports will be displayed here</p>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="fees" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Payment status and upcoming fees</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {fees.map((fee) => (
                  <div key={fee.id} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Badge variant={fee.status === "Paid" ? "outline" : "default"}>{fee.status}</Badge>
                    </div>
                  </div>
                ))}
              </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <p className="font-medium">
                          {["Dr. Robert Chen (Math)", "Sarah Johnson (English)", "Michael Williams (Science)"][i - 1]}
                        </p>
