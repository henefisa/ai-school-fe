    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-2">
          <CardHeader className="pb-3">
            ...
            <CardDescription>Overview of your fee payments for the current academic year.</CardDescription>
          </CardHeader>
        ...
        <TabsContent value="all" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View all your fee invoices and their payment status.</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          {invoice.status === "Pending" && (
                            <Dialog
                              open={isPaymentDialogOpen && selectedInvoice?.id === invoice.id}
                              onOpenChange={(open) => {
                            ...
                            >
                              ...
                              <DialogContent>
                                <DialogHeader>
                                  ...
                                  <DialogDescription>
                                    Pay for invoice {selectedInvoice?.id} - {selectedInvoice?.feeCategory}
                                  </DialogDescription>
                                </DialogHeader>
                                {paymentSuccess ? (
                                  <div className="flex flex-col items-center justify-center py-6">
                                    ...
                                    <p className="mt-4 text-center text-lg font-medium">Payment successful!</p>
                                  ...
                                  <form onSubmit={handlePayment}>
                                    <div className="grid gap-4 py-4">
                                      <div className="grid gap-2">
                                        ...
                                        <Input id="amount" value={`$${selectedInvoice?.amount.toFixed(2)}`} disabled />
                                      </div>
                                      <div className="grid gap-2">
                                    ...
                                    <DialogFooter>
                                      ...
                                      <Button type="submit">Pay ${selectedInvoice?.amount.toFixed(2)}</Button>
                                    </DialogFooter>
                                  </form>
                                )}
                              </DialogContent>
                      ...
                      <TableRow key={invoice.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            >
                              <DialogTrigger asChild>
                                <Button variant="default" onClick={() => setSelectedInvoice(invoice)}>
                                  Pay Now
                                </Button>
                              </DialogTrigger>
                              <DialogContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Overview of the fee structure for the current academic year.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>Annual library maintenance and book acquisition fee</TableCell>
                <TableCell>$2,000.00</TableCell>
                <TableCell>Annual</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium">Technology Fee</TableCell>
                <TableCell>Fee for computer labs and technology resources</TableCell>
                <TableCell>$1,500.00</TableCell>
                <TableCell>Annual</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium">Sports Fee</TableCell>
                <TableCell>Fee for sports equipment and facilities maintenance</TableCell>
