...
export default function CalendarPage() {
  ...
  // Sample events data
  const events = [
    { id: 1, date: "2025-03-15", title: "Parent-Teacher Meeting", type: "meeting" },
    ...
    { id: 6, date: "2025-03-28", title: "English Literature Exam - Grade 11", type: "exam" },
    { id: 7, date: "2025-03-30", title: "End of Month Review", type: "meeting" },
  ]
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>School calendar with all scheduled events and activities</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Events scheduled for the next two weeks</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {events.map((event) => (
              <div key={event.id} className="flex items-start gap-4 border-b pb-4 last:border-0 last:pb-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-md bg-muted">
                  <span className="text-lg font-semibold">{event.date.split("-")[2]}</span>
                </div>
