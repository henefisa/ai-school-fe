          ...
          <TabsContent value='content' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Describe the content and objectives of your lesson
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Tip: Use bullet points to list objectives (e.g., "•
                    Understand...", "• Apply...")
                  </p>
                </div>
              </CardContent>
          ...
          <TabsContent value='resources' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add documents, videos, and links for your lesson
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='flex flex-wrap gap-2'>
                  <Button
                    type='button'
                    variant='outline'
                    onClick={() => handleAddResource('document')}
                  >
                ...
                <div className='space-y-4'>
                  {resources.length === 0 ? (
                    <div className='flex flex-col items-center justify-center py-8 border-2 border-dashed rounded-md'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Click one of the buttons above to add resources
                      </p>
                    </div>
                  ) : (
                ...
                <div className='space-y-4'>
                  <div className='flex items-center space-x-2'>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleCheckboxChange('hasQuiz', checked as boolean)
                      }
                    />
