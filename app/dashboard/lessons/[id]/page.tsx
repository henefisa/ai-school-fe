...
export default function LessonDetailPage({
  ...
  const [attendanceStatus, setAttendanceStatus] = useState<
    Record<number, 'present' | 'absent' | 'not-taken'>
  >(
    students.reduce(
      (acc, student) => ({
        ...acc,
        [student.id]: student.status as 'present' | 'absent' | 'not-taken',
      }),
      {},
    ),
  );
  ...
  const handleAttendanceChange = (
    studentId: number,
    status: 'present' | 'absent' | 'not-taken',
  ) => {
      ...
      <div className='grid gap-6 md:grid-cols-3'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              <Badge
                variant={lesson.status === 'upcoming' ? 'default' : 'outline'}
              >
        ...
        <TabsContent value='resources' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Access and manage resources for this lesson
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value='attendance' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track student attendance for this lesson
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value='interactive' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage interactive elements for this lesson
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-6'>
                  ...
                  <div className='p-4 border rounded-md'>
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='flex gap-2'>
                        ...
                        <Link
                          href={`/dashboard/assignments/${lesson.assignment.id}/edit`}
                        >
                          <Button size='sm'>
                            <PencilIcon className='mr-2 h-4 w-4' />
                            Edit
