...
import { User, Globe, Shield, Users, BookOpen, CreditCard, Library, Server } from "lucide-react"
        ...
        <div className="flex-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {activeTab === "general" && "Manage your general settings and preferences."}
                {activeTab === "profile" && "Update your profile information."}
                {activeTab === "account" && "Manage your account security settings."}
                {activeTab === "users" && "Manage users, roles, and permissions."}
                {activeTab === "courses" && "Manage courses and assignments."}
                {activeTab === "fees" && "Manage fee categories and payment settings."}
                {activeTab === "library" && "Manage library resources and settings."}
                {activeTab === "system" && "Configure system-wide settings."}
              </CardDescription>
            </CardHeader>
            <Separator />
            <CardContent className="pt-6">{tabs.find((tab) => tab.id === activeTab)?.component}</CardContent>
          </Card>
        </div>
      </div>
    </div>
