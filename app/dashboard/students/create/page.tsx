          ...
          <TabsContent value="personal" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter the student's basic personal information</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="student-id" placeholder="Will be auto-generated if left blank" />
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="previous-school" placeholder="Enter previous school name" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="additional-notes" placeholder="Enter any additional academic information" />
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
          ...
          <TabsContent value="parent" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter the student's parent or guardian details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="parent-email" type="email" placeholder="Enter email address" required />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="parent-phone">Phone Number</Label>
                    <Input id="parent-phone" type="tel" placeholder="Enter phone number" required />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="parent-address">Address (if different from student)</Label>
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" type="button" onClick={() => setActiveTab("academic")}>
                  Previous
                </Button>
