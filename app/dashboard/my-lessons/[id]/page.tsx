    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{isLessonViewed ? "100%" : "0%"}</div>
        ...
        <TabsContent value="resources" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Access resources for this lesson</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="assignments" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and complete assignments for this lesson</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {!lesson.hasAssignment && !lesson.hasQuiz ? (
                  <div className="flex flex-col items-center justify-center py-8">
                    <FileText className="h-12 w-12 text-muted-foreground mb-4" />
                    <p className="text-muted-foreground">No assignments or quizzes available</p>
                  </div>
                ) : (
                  <>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <Link href={`/dashboard/assignments/${lesson.assignment.id}`}>
                              <Button variant="outline" size="sm">
                                {lesson.assignment.status === "not-started" ? "Start" : "Continue"}
                              </Button>
                            </Link>
                          </div>
                        </div>
        ...
        <TabsContent value="discussion" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Participate in the class discussion</CardDescription>
            </CardHeader>
            <CardContent>
              {!lesson.hasDiscussion ? (
                <div className="flex flex-col items-center justify-center py-8">
                  <MessageSquare className="h-12 w-12 text-muted-foreground mb-4" />
                  <p className="text-muted-foreground">No discussion forum available</p>
                </div>
              ) : (
                <div className="space-y-4">
                  <div className="p-4 border rounded-md">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <Link href={`/dashboard/discussions/${lesson.discussion.id}`}>
                          <Button variant="outline" size="sm">
                            View Discussion
                          </Button>
                        </Link>
