      ...
      <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Generate and view reports on various aspects of the school.
          </p>
        </div>
        ...
        <TabsContent value='academic' className='space-y-4'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and download academic performance reports
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Detailed analysis of student absences
                      </p>
                    </div>
                  </div>
                  <Button variant='outline' size='sm'>
                ...
                <div className='flex items-center justify-between border-b pb-4'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Status of fee collection for all students
                      </p>
                    </div>
                  </div>
                  <Button variant='outline' size='sm'>
        ...
        <TabsContent value='custom' className='space-y-4'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your previously generated custom reports
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
