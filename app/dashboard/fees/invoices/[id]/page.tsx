                ...
                <form onSubmit={handlePaymentSubmission}>
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input id="transactionId" name="transactionId" placeholder="Enter transaction ID" />
                    </div>
                    <div className="grid gap-2">
      ...
      <Card>
          ...
          <div className="space-y-4">
            ...
            {invoice.items.map((item, index) => (
              <div key={index} className="grid grid-cols-12">
                ...
                <div className="col-span-4 text-right">${item.amount.toFixed(2)}</div>
              </div>
            ))}
            <Separator />
            <div className="grid grid-cols-12 font-medium">
              <div className="col-span-8 text-right">Total</div>
              <div className="col-span-4 text-right">${invoice.amount.toFixed(2)}</div>
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex flex-col items-start">
          ...
          <p className="text-sm text-muted-foreground">
            Please make payment by the due date. For any questions regarding this invoice, please contact the finance
            office at finance@school.edu or call (555) 123-4567.
          </p>
        </CardFooter>
      </Card>
    </div>
