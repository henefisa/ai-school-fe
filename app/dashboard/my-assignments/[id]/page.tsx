...
export default function AssignmentDetailPage({
  ...
  const assignment = {
    ...
    resources: [
      {
        id: 1,
        name: 'The Great Gatsby - Essay Guidelines.pdf',
        size: '245 KB',
      },
                ...
                <div className='space-y-4'>
                  {assignment.submissionType === 'file' ? (
                    ...
                    <div className='p-4 border rounded-md bg-gray-50'>
                      <p className='text-sm'>
                        {submissionContent ||
                          'Your submitted text response would appear here.'}
                      </p>
                    </div>
                  )}
                </div>
              ...
              <CardFooter>
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    notified when it has been graded.
                  </AlertDescription>
                </Alert>
              </CardFooter>
            </Card>
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='p-4 border rounded-md bg-gray-50'>
                      <p className='text-sm'>
                        Excellent analysis of the American Dream theme in The
                        Great Gatsby. Your thesis was clear and well-supported
                        with textual evidence. Your discussion of how the green
                        light symbolizes Gatsby's unattainable dream was
                        particularly insightful. Areas for improvement: -
                        Consider the historical context of the 1920s more deeply
                        - Some of your paragraph transitions could be smoother -
                        Watch for occasional grammar issues, particularly with
                        comma usage Overall, this is strong work that
                        demonstrates a good understanding of the novel and its
                        themes.
                      </p>
                    </div>
                  </div>
        ...
        <div className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Assignment materials and references
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
              ...
              <dl className='space-y-4'>
                ...
                <div className='flex flex-col'>
                  ...
                  <dd className='text-sm capitalize'>
                    {assignment.submissionType} Upload
                  </dd>
                </div>
                <div className='flex flex-col'>
                  <dt className='text-sm font-medium text-muted-foreground'>
                ...
                <div className='flex items-center gap-4 mb-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Click the button below to start your assignment
                    </p>
                  </div>
                </div>
                {getActionButton()}
