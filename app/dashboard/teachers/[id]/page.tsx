...
export default function TeacherDetailPage({ params }: { params: { id: string } }) {
  ...
  // Sample classes data
  const classes = [
    { id: 1, name: "Algebra I", grade: "10A", students: 30, schedule: "Mon, Wed, Fri 9:00 AM", room: "Room 101" },
    { id: 2, name: "Algebra I", grade: "10B", students: 28, schedule: "Mon, Wed, Fri 10:30 AM", room: "Room 101" },
    { id: 3, name: "Calculus", grade: "12A", students: 25, schedule: "Tue, Thu 9:00 AM", room: "Room 103" },
    { id: 4, name: "Geometry", grade: "11B", students: 27, schedule: "Tue, Thu 11:00 AM", room: "Room 102" },
  ]
  ...
  const schedule = [
    {
      day: "Monday",
      periods: [
        { time: "9:00 AM - 10:20 AM", class: "Algebra I (10A)", room: "Room 101" },
        { time: "10:30 AM - 11:50 AM", class: "Algebra I (10B)", room: "Room 101" },
        { time: "1:00 PM - 2:20 PM", class: "Office Hours", room: "Faculty Office" },
      ],
    },
    {
      day: "Tuesday",
      periods: [
        { time: "9:00 AM - 10:20 AM", class: "Calculus (12A)", room: "Room 103" },
        { time: "11:00 AM - 12:20 PM", class: "Geometry (11B)", room: "Room 102" },
        { time: "2:30 PM - 4:00 PM", class: "Department Meeting", room: "Conference Room" },
      ],
    },
    {
      day: "Wednesday",
      periods: [
        { time: "9:00 AM - 10:20 AM", class: "Algebra I (10A)", room: "Room 101" },
        { time: "10:30 AM - 11:50 AM", class: "Algebra I (10B)", room: "Room 101" },
        { time: "1:00 PM - 3:00 PM", class: "Curriculum Development", room: "Faculty Office" },
      ],
    },
    {
      day: "Thursday",
      periods: [
        { time: "9:00 AM - 10:20 AM", class: "Calculus (12A)", room: "Room 103" },
        { time: "11:00 AM - 12:20 PM", class: "Geometry (11B)", room: "Room 102" },
        { time: "1:30 PM - 3:00 PM", class: "Student Tutoring", room: "Library" },
      ],
    },
    {
      day: "Friday",
      periods: [
        { time: "9:00 AM - 10:20 AM", class: "Algebra I (10A)", room: "Room 101" },
        { time: "10:30 AM - 11:50 AM", class: "Algebra I (10B)", room: "Room 101" },
        { time: "1:00 PM - 2:30 PM", class: "Faculty Meeting", room: "Auditorium" },
      ],
    },
  ]
        ...
        <div className="space-y-6 md:col-span-5">
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{teacher.experience.split(" ")[0]}</div>
            ...
            <TabsContent value="schedule" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Current teaching and administrative schedule</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    {schedule.map((day) => (
            ...
            <TabsContent value="performance" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Teacher performance based on key metrics</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
            ...
            <TabsContent value="documents" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Important documents related to this teacher</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between border-b pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Uploaded on Sep 1, 2010</p>
                        </div>
                      </div>
                      <Button variant="ghost" size="sm">
                        <Download className="mr-2 h-4 w-4" />
                    ...
                    <div className="flex items-center justify-between border-b pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Uploaded on Sep 5, 2010</p>
                        </div>
                      </div>
                      <Button variant="ghost" size="sm">
                        <Download className="mr-2 h-4 w-4" />
                    ...
                    <div className="flex items-center justify-between border-b pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Uploaded on Sep 10, 2010</p>
                        </div>
                      </div>
                      <Button variant="ghost" size="sm">
                        <Download className="mr-2 h-4 w-4" />
