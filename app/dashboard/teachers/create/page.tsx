          ...
          <TabsContent value="personal" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter the teacher's basic personal information</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="employee-id" placeholder="Will be auto-generated if left blank" />
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="emergency-contact" placeholder="Enter emergency contact name and number" required />
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="experience" placeholder="Enter years of teaching experience" required />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="specialization">Specialization</Label>
                  <Input id="specialization" placeholder="Enter area of specialization" required />
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
          ...
          <TabsContent value="classes" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Assign classes and schedule for the teacher</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="algebra-10a" className="h-4 w-4 rounded border-gray-300" />
                      <Label htmlFor="algebra-10a">Algebra I (10A)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="algebra-10b" className="h-4 w-4 rounded border-gray-300" />
                      <Label htmlFor="algebra-10b">Algebra I (10B)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="calculus-12a" className="h-4 w-4 rounded border-gray-300" />
                      <Label htmlFor="calculus-12a">Calculus (12A)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="geometry-11b" className="h-4 w-4 rounded border-gray-300" />
                ...
                <div className="space-y-2">
                  <Label htmlFor="additional-responsibilities">Additional Responsibilities (Optional)</Label>
                  <Textarea id="additional-responsibilities" placeholder="Enter any additional responsibilities" />
                </div>
