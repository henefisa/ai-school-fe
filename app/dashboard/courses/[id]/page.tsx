...
export default function CourseDetailsPage() {
  ...
  const assignments = [
    {
      id: 1,
      name: 'Homework 1: Basic Equations',
      dueDate: 'Sep 15, 2023',
      status: 'Completed',
      maxPoints: 100,
    },
    ...
    {
      id: 3,
      name: 'Homework 2: Linear Functions',
      dueDate: 'Sep 29, 2023',
      status: 'In Progress',
      maxPoints: 100,
    },
    ...
    {
      id: 5,
      name: 'Homework 3: Quadratic Equations',
      dueDate: 'Oct 27, 2023',
      status: 'Upcoming',
      maxPoints: 100,
    },
              ...
              <Card>
                <CardHeader className='flex flex-row items-center justify-between'>
                  <div>
                    ...
                    <CardDescription>
                      {enrolledStudents.length} of {course.maxStudents} students
                      enrolled
                    </CardDescription>
                  </div>
                  <Button size='sm'>
            ...
            <CardContent>
              <div className='space-y-4'>
                <div>
                  ...
                  <Progress
                    value={(enrolledStudents.length / course.maxStudents) * 100}
                    className='h-2 mt-2'
                  />
                </div>
                <div className='pt-2'>
