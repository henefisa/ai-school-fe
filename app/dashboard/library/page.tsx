...
const digitalResources = [
  ...
  },
  {
    ...
    category: "History",
    type: "PDF",
    description: "An overview of ancient civilizations and their contributions.",
  },
  {
    id: 3,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">Search for books, browse by category, and access digital resources.</p>
      </div>
      ...
      <Tabs defaultValue="books" value={activeTab} onValueChange={setActiveTab}>
                ...
                <Card key={book.id} className="overflow-hidden">
                  ...
                  <CardFooter className="p-4 pt-0">
                    <Button asChild className="w-full">
                      <Link href={`/dashboard/library/books/${book.id}`}>View Details</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
          ...
          {filteredDigitalResources.length === 0 ? (
            <div className="flex h-[400px] items-center justify-center rounded-md border border-dashed">
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <h3 className="text-lg font-semibold">No digital resources found</h3>
                <p className="text-sm text-muted-foreground">
                  Try adjusting your search or filter to find what you're looking for.
                </p>
              </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {filteredDigitalResources.map((resource) => (
                <Card key={resource.id} className="overflow-hidden">
                  ...
                  <CardFooter className="p-4 pt-0">
                    <Button asChild className="w-full">
                      <Link href={`/dashboard/library/digital/${resource.id}`}>Access Resource</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
        ...
        <TabsContent value="borrowed" className="space-y-6">
          <div className="rounded-md border">
            <div className="p-4">
              <h3 className="text-lg font-semibold">Currently Borrowed Items</h3>
              <p className="text-sm text-muted-foreground">View and manage your currently borrowed books.</p>
            </div>
            <div className="border-t">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b">
                    <td className="p-4">Harry Potter and the Philosopher's Stone</td>
          ...
          <div className="rounded-md border">
            <div className="p-4">
              ...
              <p className="text-sm text-muted-foreground">View your past borrowing history.</p>
            </div>
            <div className="border-t">
              <table className="w-full">
                <thead>
