                    ...
                    <>
                      <div className='space-y-4 py-4'>
                        ...
                        <div className='rounded-md bg-muted p-3 text-sm'>
                          <p>
                            By checking out this book, you agree to return it by
                            the due date. Late returns may incur fines.
                          </p>
                        </div>
                      </div>
                      <DialogFooter>
                  ...
                  {reserveSuccess ? (
                    ...
                    <>
                      <div className='space-y-4 py-4'>
                        ...
                        <div className='rounded-md bg-muted p-3 text-sm'>
                          <p>
                            By reserving this book, you will be notified when it
                            becomes available. You will then have 48 hours to
                            check it out before the reservation expires.
                          </p>
                        </div>
                      </div>
                      <DialogFooter>
