...
import { ArrowLeft, Download, FileText, Loader2, Save, Send } from "lucide-react"
...
export default function GradeSubmissionPage({
  ...
  const [feedback, setFeedback] = useState<string>("Excellent work! All problems solved correctly.")
  ...
  const submission = {
    ...
    files: [{ id: 1, name: "Quadratic_Equations_Solutions.pdf", size: "1.8 MB" }],
  }
                ...
                <TabsContent value="submission" className="space-y-4 mt-4">
                  <div className="space-y-4">
                    {submission.files.map((file) => (
                      <div key={file.id} className="flex items-center gap-4 p-4 border rounded-md">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardFooter className="flex flex-col gap-2">
              <Button className="w-full" onClick={handleSaveGrade} disabled={isLoading}>
                {isLoading ? (
                  <>
            ...
            <CardContent>
              <dl className="space-y-4">
                <div className="flex flex-col">
                  <dt className="text-sm font-medium text-muted-foreground">Assignment</dt>
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="text-sm">{new Date(assignment.dueDate).toLocaleDateString()}</dd>
                </div>
                <div className="flex flex-col">
                  <dt className="text-sm font-medium text-muted-foreground">Submission Date</dt>
                  <dd className="text-sm">{new Date(submission.submittedAt).toLocaleString()}</dd>
                </div>
                <div className="flex flex-col">
