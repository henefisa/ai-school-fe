              ...
              <CardContent>
                <dl className='space-y-4'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <dd className='text-sm'>
                      {assignment.gradeVisibility === 'after_grading' &&
                        'After grading'}
                      {assignment.gradeVisibility === 'after_due_date' &&
                        'After due date'}
                      {assignment.gradeVisibility === 'immediately' &&
                        'Immediately'}
                      {assignment.gradeVisibility === 'manual' &&
                        'Manual release'}
                    </dd>
                  </div>
                </dl>
                ...
                <div className='flex items-center gap-4 mb-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      {assignment.assignedTo.totalStudents} students
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    <div className='flex justify-between mb-1'>
                      ...
                      <span className='text-sm text-muted-foreground'>
                        ...
                        {assignment.assignedTo.totalStudents}
                      </span>
                    </div>
                    <Progress
                      value={
        ...
        <TabsContent value='resources' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Files and resources for this assignment
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold text-amber-600'>
                      {assignment.submissions.ungraded}
                    </div>
                    <p className='text-xs text-muted-foreground'>
                      {(
                        (assignment.submissions.ungraded /
              ...
              <div className='space-y-4'>
                ...
                <div className='flex justify-between items-center p-4 border rounded-md'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      {assignment.gradeVisibility === 'after_grading' &&
                        'Grades visible after grading'}
                      {assignment.gradeVisibility === 'after_due_date' &&
                        'Grades visible after due date'}
                      {assignment.gradeVisibility === 'immediately' &&
                        'Grades visible immediately'}
                      {assignment.gradeVisibility === 'manual' &&
                        'Grades visible after manual release'}
                    </p>
                  </div>
                ...
                <div className='flex justify-between items-center p-4 border rounded-md'>
                  ...
                  <Button variant='outline'>
                    {assignment.allowLateSubmissions ? 'Disallow' : 'Allow'}
                  </Button>
                </div>
