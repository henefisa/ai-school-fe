        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("visibleToStudents", checked)}
                  />
          ...
          <TabsContent value="resources" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add files and resources for students</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                  {resources.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-8 border-2 border-dashed rounded-md">
                      ...
                      <p className="text-sm text-muted-foreground">Click the button above to add resources</p>
                    </div>
                  ) : (
                    resources.map((resource) => (
                      <div key={resource.id} className="flex items-center gap-4 p-4 border rounded-md">
                        <div className="flex-1">
                          <div className="space-y-2">
                            <Label htmlFor={`file-${resource.id}`}>Resource File</Label>
                            <div className="flex items-center gap-2">
                              <Input
                                id={`file-${resource.id}`}
                                type="file"
          ...
          <TabsContent value="students" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Select which students will receive this assignment</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="assign-class">Assign to entire class</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="students" id="assign-students" />
                      <Label htmlFor="assign-students">Assign to specific students</Label>
                    </div>
                  </RadioGroup>
                    ...
                    <div className="mt-4 border rounded-md p-4">
                      <div className="mb-2 flex justify-between items-center">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            if (formData.selectedStudents.length === allStudentIds.length) {
                              // Deselect all
                      ...
                      <div className="space-y-2 max-h-60 overflow-y-auto pr-2">
                        {students.map((student) => (
                          <div key={student.id} className="flex items-center space-x-2 p-2 border rounded-md">
                            <Checkbox
          ...
          <TabsContent value="settings" className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-6">
                    ...
                    <div className="ml-6 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          className="w-24"
                        />
                        <span className="text-sm text-muted-foreground">% deduction per day</span>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSelectChange("gradeVisibility", value)}
                  >
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" type="button" onClick={() => setActiveTab("students")}>
                  Previous
                </Button>
